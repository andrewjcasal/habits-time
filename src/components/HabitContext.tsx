...
const HabitContext: React.FC<HabitContextProps> = ({ 
  habitId, 
  habitName, 
  initialContext 
}) => {
  ...
  const [activeSection, setActiveSection] = useState<'background' | 'wins' | 'consequences'>('background');
  ...
  const handleContentChange = (section: 'background' | 'wins' | 'consequences', content: string) => {
