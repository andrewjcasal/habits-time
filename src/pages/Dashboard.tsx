import { ArrowRight, BookOpen, Code, Clock, Calendar, Target, Users, TrendingUp, Layout, Briefcase } from 'lucide-react';
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    // Get recent activity
    const activity = [
      ...problems.filter((p: any) => p.lastAttempted).map((p: any) => ({
        type: 'problem',
        title: p.title,
      ...
      ...applications.filter((a: any) => a.dateApplied).map((a: any) => ({
        type: 'application',
        title: a.company,
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Stat 
          ...
          icon={Users}
          href="/interview-prep"
          trend={stats.interviewsCompleted > 0 ? `Last: 2 days ago` : "Practice now!"}
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
        ...
        >
          ...
          <p className="text-neutral-600 mb-4">
            Practice coding interview problems with spaced repetition to maximize retention.
          </p>
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <ProgressRing 
                ...
                color="#3B82F6" 
              />
              <span className="ml-2 text-sm text-neutral-600">{neetcodeProgress}% complete</span>
            </div>
        ...
        >
          ...
          <p className="text-neutral-600 mb-4">
            Personalized interview preparation based on job posts. Practice with an AI interviewer.
          </p>
        ...
        >
          ...
          <p className="text-neutral-600 mb-4">
            Track applications and networking contacts. Stay organized in your job search.
          </p>
          <div className="mt-auto flex justify-end">
        ...
        {recentActivity.length > 0 ? (
          <ul className="space-y-3">
            {recentActivity.map((activity, index) => (
              <li key={index} className="flex items-center justify-between p-3 rounded-md hover:bg-neutral-50">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-500">
                      {activity.type === 'problem' ? 'Solved problem' : 
                       activity.type === 'interview' ? 'Completed interview' : 
                       'Applied to company'}
                    </p>
                  </div>
                </div>
          ...
          <div className="text-center py-6 text-neutral-500">
            <p>No recent activity yet. Start using the app to track your progress!</p>
          </div>
        )}
      </div>
    </div>
