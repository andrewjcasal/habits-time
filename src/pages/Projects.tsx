...
const Projects = () => {
  ...
  } = useTasks(user ? selectedProject?.id : undefined)
  ...
  } = useSessions(user ? selectedProject?.id : undefined)

  // Public project hooks
  ...
  const {
    ...
    isShareable,
  } = usePublicProject(!user && projectParam ? projectParam : undefined)
  ...
  useEffect(() => {
    if (!user) {
      ...
      if (publicProject) {
        setSelectedProject(publicProject)
  ...
  }, [user, projects, projectsLoading, searchParams, publicProject])
  ...
  // Show loading for unauthenticated users while checking project
  if (!user && publicProjectLoading) {
    return (
        ...
        {currentProject ? (
          <div className="flex-1 flex overflow-hidden">
            ...
            <TasksList
              ...
              onShowNewTaskForm={user ? () => setShowNewTaskForm(true) : undefined}
