...
const Essentials = () => {
  ...
  const createEssential = async () => {
    ...
    const existingEssential = essentials.find(
      (essential) =>
        essential.activity_type_id === newEssential.activity_type_id
    );
        ...
        essentials.map((essential) => {
          if (essential.id === id) {
            const activityType = activityTypes.find(
              (at) => at.id === editForm.activity_type_id
            );
            return {
              ...essential,
              activity_type_id: editForm.activity_type_id,
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-neutral-600">
            Define the most important activities you want to complete each day
            and set time allocations.
          </p>
        </div>
          ...
          {essentials.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-lg border border-neutral-200">
              ...
              <p className="text-neutral-600 mb-4">
                Add your first essential to get started.
              </p>
              <button
                onClick={() => setShowAddForm(true)}
